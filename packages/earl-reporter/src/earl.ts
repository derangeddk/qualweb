 ...
 */
export function generateEARLAssertions(report: EvaluationReport, date?: string): Array<Assertion> {
 ...
 *
 * @param {Assertion} test - the test where the sources are generated
 * @returns list of result sources from a test
 */
function generateSources(test: EvaluationAssertion): Array<ResultSource> {
 ...
 *
 * @param {QualwebReport} report - qualweb report to convert
 * @param {EarlOptions} options - options of conversion (check https://github.com/qualweb/core#options)
 * @returns earl evaluation report with one test subject
 */
function generateSingleEarlReport(report: QualwebReport, options?: EarlOptions): EarlReport {
 ...
 *
 * @param {QualwebReport[]} reports - qualweb reports to convert
 * @param {EarlOptions} options - options of conversion (check https://github.com/qualweb/core#options)
 * @returns earl evaluation report with multiple test subjects
 */
function generateAggregatedEarlReport(reports: QualwebReport[], options?: EarlOptions): EarlReport {
 ...
 *
 * @param {QualwebReports} reports - evaluation reports to convert to EARL
 * @param {EarlOptions} options - options of conversion (check https://github.com/qualweb/core#options)
